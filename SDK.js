...
class Ipay {
    ...
    async createOrder(items) {
        ...
        const checkoutDetails = {
            ...
            success_redirect_url: `${this.options.redirect_url}/?installment_success`,
            fail_redirect_url: `${this.options.redirect_url}?installment_fail`,
            reject_redirect_url: `${this.options.redirect_url}`,
            validate_items: true,
